                            ...
                            <b-card no-body
                                ...
                                <b-list-group flush>
                                    <b-list-group-item class="py-4">
                                        <b-link :href="`https://github.com/DigiSwap-Core/erc20-generator/blob/v${token.version}/dist/${contracts.token.contractName}.dist.sol`"
                                                target="_blank">
                                            <b-img :src="`https://img.shields.io/badge/version-${token.version}-blue`"></b-img>
                                        </b-link>
                                        <b-link href="https://github.com/DigiSwap-Core/erc20-generator/actions" target="_blank">
                                            <b-img src="https://github.com/DigiSwap-Core/erc20-generator/workflows/CI/badge.svg?branch=master"></b-img>
                                        </b-link>
                                        <b-link href="https://coveralls.io/github/DigiSwap-Core/erc20-generator?branch=master" target="_blank">
                                            <b-img src="https://coveralls.io/repos/github/DigiSwap-Core/erc20-generator/badge.svg?branch=master"></b-img>
                                        </b-link>
                                        <b-link href="https://github.com/DigiSwap-Core/erc20-generator/blob/master/LICENSE" target="_blank">
                                            <b-img src="https://img.shields.io/github/license/DigiSwap-Core/erc20-generator.svg"></b-img>
                                        </b-link>
                                    </b-list-group-item>
                                    <b-list-group-item class="py-4">
