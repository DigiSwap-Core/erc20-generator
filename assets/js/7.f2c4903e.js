          ...
          methods: {
                          ...
                          .on("receipt", (e) => {
                            (this.token.address = e.contractAddress),
                              (this.token.link =
                                ...
                                "/token/" +
                                this.token.address),
                              (this.token.widget = `https://digiswap-core.github.io/watch-token/create/?address=${this.token.address}&network=${this.currentNetwork}`),
                              this.$forceUpdate(),
                              this.makeToast(
                                "Well done!",
            ...
            updateTokenDetails() {
              ...
              (this.token.customizeDecimals = e.customizeDecimals),
                ...
                (this.token.transferType = e.transferType),
                (this.token.mintable = e.mintable),
                (this.token.burnable = e.burnable),
                (this.token.erc1363 = e.erc1363),
        ...
        i = Object(r.a)(
          ...
          function () {
            ...
            return t(
              ...
              [
                t("b-jumbotron", {
                  staticClass: "mb-0 aqua-gradient",
                  attrs: {
                    "text-variant": "white",
